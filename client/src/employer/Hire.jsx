...
import { MapPin, Building, Clock, IndianRupee, Users, Star, X, Plus } from "lucide-react";
  ...
  const validateForm = () => {
    ...
    if (formData.salary) {
      if (!/^\d+(\s*-\s*\d+)?$/.test(formData.salary.replace(/,/g, ''))) {
        ...
        const [min, max] = formData.salary.split('-').map(num => parseInt(num.replace(/[^\d]/g, '')));
        if (max && min >= max) {
          newErrors.salary = "Maximum salary should be greater than minimum salary";
        }
      }
    }
          ...
          <div className="bg-white rounded-xl shadow-sm p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="flex items-center gap-6 bg-gray-50 p-6 rounded-xl border border-gray-100">
                ...
                <div>
                  <h3 className="font-medium text-lg">{formData.companyName}</h3>
                  <p className="text-sm text-gray-500">Posting as employer</p>
                </div>
              </div>

              <div>
                <label className="block font-medium mb-2">Job Title<span className="text-red-500">*</span></label>
                <input
                  type="text"
                  ...
                  className={`w-full px-4 py-3 rounded-lg border ${errors.title ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:border-black`}
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <label className="block font-medium mb-2">Location<span className="text-red-500">*</span></label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-12 pr-4 py-3 rounded-lg border ${errors.location ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:border-black`}
                ...
                <div>
                  <label className="block font-medium mb-2">Job Type<span className="text-red-500">*</span></label>
                  <select
                    value={formData.type}
              ...
              <div className="space-y-4">
                <label className="block font-medium">Salary Range<span className="text-red-500">*</span></label>
                  ...
                  <div className="flex-1">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-12 pr-4 py-3 rounded-lg border ${errors.salary ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:border-black`}
              ...
              <div>
                <label className="block font-medium mb-2">Working Hours<span className="text-red-500">*</span></label>
                <div className="flex gap-4 items-start">
                  <div className="flex-1">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-12 pr-4 py-3 rounded-lg border ${errors.workingHours ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:border-black`}
                        placeholder="e.g. 40"
                      />
                    </div>
                  ...
                  <select
                    ...
                    onChange={(e) => setFormData(prev => ({ ...prev, workingHoursType: e.target.value }))}
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`w-full px-4 py-3 rounded-lg border ${errors.description ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:border-black h-40 resize-none`}
        ...
        <div className="fixed inset-0 bg-black/25 backdrop-blur-[2px] z-50 flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-2xl rounded-xl p-6 animate-slide-up">
              ...
              <div className="flex gap-4 items-start">
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-2 flex flex-wrap gap-2">
                    ...
                    <span className="text-sm text-gray-600">• ₹{formData.salary} {formData.salaryType === 'monthly' ? 'per month' : 'per day'}</span>
                    <span className="text-sm text-gray-600">• {formData.workingHours} hours {formData.workingHoursType}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="text-center text-gray-600">
              <p>Your job posting is now live and visible to potential candidates!</p>
              <div className="mt-6">
                <button 
                  onClick={() => setShowSuccess(false)}
