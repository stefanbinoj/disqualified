...
const Profile = () => {
  ...
  const [profileData, setProfileData] = useState({
    ...
    about: "Experienced Full Stack Developer with 5+ years of hands-on experience in developing scalable web applications. Passionate about creating efficient, maintainable code and solving complex problems.",
            ...
            <div className="flex flex-col items-center text-center mb-8">
              ...
              {editMode.basic ? (
                ...
                <>
                  ...
                  <p className="text-gray-500 text-sm mt-1">{profileData.status}</p>
                  <button 
